...
public class EditDistance {
	 ...
	 * The number of new nodes added from one TreeNode is limited by bound.
	 */
...
//			System.out.println("*** OPEN: \n"+open);
	 ...
	 * and graph @param g2 using the cost function @param cf
	 * s is the maximum number of open paths used in beam-search.
	 * The starting TreeNode is given and number of new open paths
	 * per one TreeNode is unlimited.
	 */
